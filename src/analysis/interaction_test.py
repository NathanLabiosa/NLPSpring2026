...
DATASETS = {
    "original_rate": {
        "cosine": "results/bootstrap/cosv2_L15_stab24_high/paired_bootstrap_results.json",
        "mse":    "results/bootstrap/mse_L15_stab24_high/paired_bootstrap_results.json",
        "label":  "Original rates (typos 5%, OCR 5%, WS 10%, case 10%, speech 10%, homo 20%)",
    },
    "matched_rate": {
        "cosine": "results/bootstrap/phi_matched_cosine_stab24/paired_bootstrap_results.json",
        "mse":    "results/bootstrap/phi_matched_mse_stab24/paired_bootstrap_results.json",
        "label":  "Matched rate (all perturbations at 10%)",
    },
}

OUTPUT_DIR = "results/workstream_a/interaction_test"
