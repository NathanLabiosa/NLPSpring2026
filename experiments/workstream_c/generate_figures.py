...
def figure_c1():
    ...
    models = {
        "Phi-3.5": {
            "path": os.path.join(ROOT, "Phi3.5/lrd_gsm/raw_gsm8k.json"),
            "title": "Phi-3.5 (spike-and-suppress)",
        },
        "Llama-3": {
            "path": os.path.join(ROOT, "Llama/lrd_results/raw_gsm8k.json"),
...
def figure_c2():
    ...
    patching_files = {
        "Phi-3.5 (typos)": os.path.join(ROOT, "Phi3.5/lrd_results/phi_patching_v3/patching_gsm8k_typos.json"),
        "Llama-3 (typos)": os.path.join(ROOT, "Llama/lrd_results/patching_gsm8k_typos.json"),
    }
...
def figure_c4():
    ...
    configs = {
        "Cosine\nstab=24": os.path.join(ROOT, "bootstrap_results/cosv2_L15_stab24_high/paired_bootstrap_results.json"),
        "MSE\nstab=24": os.path.join(ROOT, "bootstrap_results/mse_L15_stab24_high/paired_bootstrap_results.json"),
    }
...
def figure_c5():
    ...
    cosine_path = os.path.join(ROOT, "bootstrap_results/cosv2_L15_stab24_high/paired_bootstrap_results.json")
    mse_path = os.path.join(ROOT, "bootstrap_results/mse_L15_stab24_high/paired_bootstrap_results.json")
...
def figure_c6():
    ...
    a2_path = os.path.join(ROOT, "experiments/workstream_a/whitespace_analysis/whitespace_analysis_results.json")
...
def figure_c7():
    ...
    data_configs = {
        "original": {
            "cosine": os.path.join(ROOT, "bootstrap_results/cosv2_L15_stab24_high/paired_bootstrap_results.json"),
            "mse": os.path.join(ROOT, "bootstrap_results/mse_L15_stab24_high/paired_bootstrap_results.json"),
        },
        "matched": {
            "cosine": os.path.join(ROOT, "bootstrap_results/phi_matched_cosine_stab24/paired_bootstrap_results.json"),
            "mse": os.path.join(ROOT, "bootstrap_results/phi_matched_mse_stab24/paired_bootstrap_results.json"),
        },
    }
...
def figure_c5b():
    ...
    cosine_path = os.path.join(ROOT, "bootstrap_results/phi_matched_cosine_stab24/paired_bootstrap_results.json")
    mse_path = os.path.join(ROOT, "bootstrap_results/phi_matched_mse_stab24/paired_bootstrap_results.json")
